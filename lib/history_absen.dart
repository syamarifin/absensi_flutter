...
class _MyHistoryAbsenState extends State<MyHistoryAbsen> {
  ...
  Future<String> getData() async {
    ...
    var res = await http.get(BaseUrl.history, headers: {
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ListTile(
                            ...
                            title: Row(
                              children: <Widget>[
                                Text(data[index]['Nama'].toString(),
                                    style: TextStyle(
                                        fontSize: 15.0,
                                        fontWeight: FontWeight.bold)),
                                Text(" ("),
                                Text(data[index]['NIS'].toString(),
                                    style: TextStyle(
                                        fontSize: 15.0,
                                        fontWeight: FontWeight.bold)),
                                Text(")"),
                              ...
                              children: <Widget>[
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Text('-Masuk '),
                                    //DARI INDEX ayat
                                    Text(data[index]['a_in'].toString()),
                                    SizedBox(width: 8.0),
                                    Text('-Pulang '),
                                    //DARI INDEX ayat
                                    Text(data[index]['a_out'].toString() ==
                                            '00:00:00'
                                        ? '-'
                                        : data[index]['a_out'].toString())
                                  ],
                                ),
                              ],
                            ),
