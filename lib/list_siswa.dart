...
class ShowSiswaList extends StatefulWidget {
  static String tag = 'list-siswa';
  @override
  _ShowSiswaListState createState() => _ShowSiswaListState();
}

class _ShowSiswaListState extends State<ShowSiswaList> {
  var loading = false;
  List data;
  List unFilterData;
  String jk;
  Future<String> getData() async {
    ...
    var res = await http.get(BaseUrl.listsiswa, headers: { 'accept':'application/json','Content-Type':'application/json'});
                            ...
                            mainAxisSize: MainAxisSize.min, children: <Widget>[
                              ListTile(
                                ...
                                subtitle: Column(crossAxisAlignment: CrossAxisAlignment.start,children: <Widget>[ //MENGGUNAKAN COLUMN
                                    ...
                                    Row(
                                      children: <Widget>[
                                        Text(data[index]['TempatLahir'].toString()),
                                        Text(','),
                                        Text(data[index]['TglLahir'].toString()),
                                      ],
                                    ),
                                    Row(
                                      children: <Widget>[
